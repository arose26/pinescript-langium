/**
 * This file contains implementations of built-in PineScript functions
 * that will be used in the generated JavaScript code.
 */
...
export function getBuiltinsCode(): string {
    return builtins;
}
